	...
	)
{
	...
	{
		io_bSyncOpen = true;
		return CAkMultipleFileLocation::Open(in_pszFileName, in_eOpenMode, in_pFlags, true, out_fileDesc);
	}
	...
	)
{
	...
	{
		io_bSyncOpen = true;
		return CAkMultipleFileLocation::Open(in_fileID, in_eOpenMode, in_pFlags, true, out_fileDesc);
	}
